...
<jsp:useBean id="sampleTriangleAreaProxyid" scope="session" class="com.metacube.TriangleAreaProxy" />
<%
...
case 10:
        gotMethod = true;
        com.metacube.TriangleArea getTriangleArea10mtemp = sampleTriangleAreaProxyid.getTriangleArea();
...
case 13:
        ...
        double getArea13mtemp = sampleTriangleAreaProxyid.getArea(side1_1idTemp,side2_2idTemp,side3_3idTemp);
