...
public class TriangleAreaServiceLocator extends org.apache.axis.client.Service implements com.metacube.TriangleAreaService {
    ...
    private java.lang.String TriangleArea_address = "http://localhost:8080/EAD_Assignment_6/services/TriangleArea";
    ...
    public com.metacube.TriangleArea getTriangleArea() throws javax.xml.rpc.ServiceException {
    ...
    public com.metacube.TriangleArea getTriangleArea(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.metacube.TriangleAreaSoapBindingStub _stub = new com.metacube.TriangleAreaSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.metacube.TriangleArea.class.isAssignableFrom(serviceEndpointInterface)) {
                com.metacube.TriangleAreaSoapBindingStub _stub = new com.metacube.TriangleAreaSoapBindingStub(new java.net.URL(TriangleArea_address), this);
                _stub.setPortName(getTriangleAreaWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://metacube.com", "TriangleAreaService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://metacube.com", "TriangleArea"));
        }
